...
//    private final MusicRepository musicRepository = new MusicRepository();
    ...
    public void onCreate() {
        ...
        Intent activityIntent = new Intent(appContext, PostShowAppActivity.class);
...
//            prepareToPlay(track.getUri());
        ...
        private void updateMetadataFromTrack() {
            ...
            metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_TITLE, "StopGame");
            metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_ALBUM, name);
            metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_ARTIST, name);
